...
- Name: annotation\cross_doc_move.real.spec.ts >> Cross-Document Section Move (Real API Integration) >> Scenario: Drag and Drop section from Doc A to Doc B
- Location: tests\e2e\annotation\cross_doc_move.real.spec.ts:53:7
